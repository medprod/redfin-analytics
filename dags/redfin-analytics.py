...
def extract_data(**kwargs):
    ...
    #output name will be stored as such for each time we run dag
...
with DAG('redfin_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://raw-data-storage-yml',
        )
        
        #the order of how it runs
